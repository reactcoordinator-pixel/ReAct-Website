const SocialMediaLinksCard = () => {
    return (
        <div className="flex flex-col bg-center bg-cover bg-no-repeat">
            <div className="grid place-items-center mx-auto p-6 sm:my-auto bg-white rounded-3xl space-y-10">
                <h1 className="text-3xl font-semibold text-blue-500">Follow on Social Media</h1>
