...
export default function DropzoneButton({
  ...
  const handleFiles = async (files: File[]) => {
    ...
    try {
      ...
      if (
        currentLocalUrl &&
        previewUrl !== currentLocalUrl &&
        currentLocalUrl.startsWith("blob:")
      ) {
  ...
  return (
    <div className="w-full space-y-6">
      ...
      {!previewUrl && (
        <>
          ...
          >
            ...
            <p className="text-xs text-gray-400 mt-1">PNG, JPEG • Max 30MB</p>
          </div>
      ...
      {/* Image preview - using regular <img> to avoid Next.js optimizer issues */}
      {previewUrl && (
        <div className="relative rounded-xl overflow-hidden shadow-lg">
          <img
            ...
            onError={() => {
              // Fallback if remote image fails to load (e.g. invalid URL)
